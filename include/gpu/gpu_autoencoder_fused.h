#ifndef GPU_AUTOENCODER_FUSED_H
#define GPU_AUTOENCODER_FUSED_H

#include "data_loader.h"

class Gpu_Autoencoder_Fused
{
public:
 Gpu_Autoencoder_Fused(int batch_size);
 ~Gpu_Autoencoder_Fused();
...
private:
 ...
 // KHÔNG CÒN MEMORY POOL
 // Các con trỏ sẽ được cấp phát riêng lẻ bằng cudaMalloc
