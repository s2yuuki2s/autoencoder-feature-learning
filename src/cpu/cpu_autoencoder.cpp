      ...
      batch_size(batch_size_)
{
    ...
    W1 = new float[W1_size];
    b1 = new float[256];
    W2 = new float[W2_size];
    b2 = new float[128];
    W3 = new float[W3_size];
    b3 = new float[128];
    W4 = new float[W4_size];
    b4 = new float[256];
    W5 = new float[W5_size];
    b5 = new float[3];

    dW1 = new float[W1_size];
    db1 = new float[256];
    dW2 = new float[W2_size];
    db2 = new float[128];
    dW3 = new float[W3_size];
    db3 = new float[128];
    dW4 = new float[W4_size];
    db4 = new float[256];
    dW5 = new float[W5_size];
    db5 = new float[3];
