...
int main(int argc, char **argv)
{
 ...
 std::printf("=== GPU FUSED Training on CIFAR-10 ===\n");
 ...
 std::printf("=== Phase 3: GPU FUSED on CIFAR-10 ===\n");
 std::printf("Dataset dir   : %s\n", data_dir);
 ...
 Gpu_Autoencoder_Fused ae(batch_size);
 ...
 std::printf("\n=== GPU FUSED Training Completed ===\n");
 std::printf("GPU (FUSED) total training time: %.2f s\n", total_sec);
